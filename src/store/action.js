...
export const updateUrl = function ({commit, state}, {url, url2}) {
    ...
    playList[currentIndex].url2 = url2
    sequenceList[currentIndex].url2 = url2
...
export const saveMusicQuality = function ({commit}, musicQuality) {
    commit(types.SET_MUSIC_QUALITY, musicQuality)
