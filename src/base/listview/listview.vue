<template>
  <scroll class="listview" :data="data" :listenScroll="listenScroll" :probeType="probeType" ref="listview"
          @scroll="_scroll">
    <ul>
  ...
  export default {
    ...
    methods: {
      ...
      onShortcutTouchStart(e) {
        let anchorIndedx = getData(e.target, 'index')
        let firstTouch = e.touches[0]
        this.touch.y1 = firstTouch.pageY
        this.touch.anchorIndex = anchorIndedx
      ...
      onShortcutTouchMove(e) {
        ...
        let anchorIndedx = parseInt(this.touch.anchorIndex) + delta
        this._scrollTo(anchorIndedx)
        // console.log('anchorIndedx: ' + anchorIndedx)
      },
      refresh() {
      ...
      _scrollTo(index) {
        ...
        // console.log(index)
        // 点击对应高亮 设置this.scrollY 或者 scrollToElement的时间
